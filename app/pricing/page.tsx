...
const plans = [
  {
    ...
    priceDetail: '영원히',
    recommended: false,
    features: ['월 3회 AI 추정', '기본 불량 가이드 (12종)', '추정 기록 저장 (로컬)', '12가지 불량 유형 지원'],
  ...
  },
  {
    ...
    priceDetail: '월 / $19.99',
    recommended: true,
    features: ['무제한 AI 추정', '상세 원인 분석 (확률 %)', '현재 vs 권장 셋팅 비교표', '추정 기록 클라우드 저장', '수지별 권장 조건 DB', '이메일 추정 리포트', '50종 이상 수지 지원', 'PDF 저장'],
    notIncluded: [],
    btnText: 'Pro 시작',
    btnHref: '/diagnose',
  },
...
const faqs = [
  ...
  { q: '추정 정확도는 어느 정도인가요?', a: 'Mold Doctor AI는 AI 보조 도구입니다. 10년 이상의 사출 엔지니어링 지식을 기반으로 하지만, 최종 판단과 조치는 현장 엔지니어가 해야 합니다. 추정 결과를 참고 자료로 활용하세요.' },
  { q: '모바일에서도 사용 가능한가요?', a: '네, 반응형 웹앱으로 스마트폰에서도 최적화되어 있습니다. 카메라로 불량 사진을 직접 촬영해서 업로드할 수 있습니다.' },
  { q: '우리 회사 수지 데이터를 학습시킬 수 있나요?', a: 'Enterprise 플랜에서 자사 수지 DB를 등록하여 맞춤형 추정이 가능합니다. 특수 Grade나 자체 배합 수지에 대한 커스텀 지원을 제공합니다.' },
    ...
    <div className="bg-[#07090F] min-h-screen px-4 sm:px-6 py-16">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="text-center mb-16">
          ...
          <h1 className="text-4xl font-bold text-white mb-4">현장에서 바로 쓰는 AI 추정 도구</h1>

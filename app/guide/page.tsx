...
export const metadata: Metadata = {
  title: '사출 불량 가이드 — 24종 원인과 해결 방법 | Mold Doctor',
  description: '미성형·플래시·싱크마크·웰드라인 등 사출성형 불량 24종의 원인과 해결 방법을 정리했습니다.',
  alternates: {
    ...
    <div className="bg-canvas min-h-screen px-4 sm:px-6 py-10">
      ...
      <div className="max-w-4xl mx-auto">
        <div className="mb-10">
          ...
          <p className="text-muted text-body">24가지 주요 불량 유형별 원인과 해결 방향을 확인하세요.</p>
        </div>

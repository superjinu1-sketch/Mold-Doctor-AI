...
const resinKnowledge: Record<string, string> = {
  ...
  'PA410': 'PA410(EcoPaXX): semi-crystalline, bio-based(castor oil). Tm 250°C, similar to PA66. Drying: 80°C 4-6hrs, target moisture <0.08%. 30% lower moisture uptake than PA66. Melt: 270-310°C(wide processing window). Mold: 80-120°C. Fast crystallization — up to 20% shorter cycles than PA66. Shrinkage 1.5-2.5%. Common defects: sink marks(high crystallization shrinkage, especially at thick sections — mold temp critical for balancing surface quality vs shrinkage), warpage(crystallization-induced, manage with uniform mold temp). Key: processes very similarly to PA66 but crystallizes faster — gate seal time may be shorter than expected. Mold temp below 80°C gives amorphous surface with poor gloss. For sink marks at bosses, increase mold temp 80→100°C + optimize gate size for better packing.',
  ...
  'PEI(Ultem)': 'PEI: amorphous, high performance. Drying: 150°C 4-6hrs. Melt: 340-370°C. Mold: 140-175°C. Transparent amber color. Very high melt viscosity. Common defects: short shot(high viscosity), stress cracking, moisture splay. Key: very high melt viscosity requires high injection pressure.',

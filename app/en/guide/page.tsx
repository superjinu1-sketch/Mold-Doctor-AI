...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: 'Causes and solutions for 12 major injection molding defect types.',
    type: 'website',
    locale: 'en_US',
  },
    ...
    <div className="bg-canvas min-h-screen px-4 sm:px-6 py-10">
      ...
      <div className="max-w-4xl mx-auto">
        <div className="mb-10">
          ...
          <p className="text-muted text-body">Causes and solutions for 12 major injection molding defect types.</p>
        </div>

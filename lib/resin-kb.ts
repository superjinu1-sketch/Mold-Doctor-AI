...
export const RESIN_KB: Record<string, ResinSpec> = {
  ...
  'PA6': { id: 'PA6', tier: 'engineering', crystalline: true, hygroscopic: 'high',
    ...
    meltC: { min: 230, max: 260 }, moldC: { min: 60, max: 90, gf: [80, 100] }, shrinkagePct: [1.5, 2.2],
  ...
  'PA66': { id: 'PA66', tier: 'engineering', crystalline: true, hygroscopic: 'very-high',
    ...
    meltC: { min: 260, max: 290, degradeAbove: 300 }, moldC: { min: 70, max: 100, gf: [80, 120] }, shrinkagePct: [1.2, 2.0],
  ...
  'PA46': { id: 'PA46', tier: 'super-engineering', crystalline: true, hygroscopic: 'very-high',
    ...
    notes: 'PA46(Stanyl): extremely hygroscopic, Tm 295°C. Drying 16-24hrs (3-4x PA66) with dehumidifying dryer is mandatory — hot air dryers are insufficient. PA46-specific: blistering after reflow soldering (260°C+). Beyond 9-type: thermal degradation above 330°C.',
    source: 'experience', confidence: 'estimated' },
  'PA410': { id: 'PA410', tier: 'engineering', crystalline: true, hygroscopic: 'moderate',
    ...
    notes: 'PA410(EcoPaXX): bio-based, ~30% lower moisture uptake than PA66, crystallizes faster. Mold below 80°C gives amorphous surface with poor gloss. Sink at bosses: raise mold temp + optimize gate.',
    source: 'experience', confidence: 'estimated' },
  'PA4T': { id: 'PA4T', tier: 'super-engineering', crystalline: true, hygroscopic: 'low',
    ...
    commonDefects: ['flash'],
    notes: 'PA4T(ForTii): semi-aromatic PPA, excellent flow (thin walls 0.3mm+), flashes into micro-gaps so PL face precision is critical. Beyond 9-type: blistering after reflow (260-288°C), thermal degradation above 360°C.',
    source: 'experience', confidence: 'estimated' },
  ...
  'PBT': { id: 'PBT', tier: 'engineering', crystalline: true, hygroscopic: 'moderate',
    ...
    meltC: { min: 230, max: 270 }, moldC: { min: 60, max: 100 }, shrinkagePct: [1.5, 2.2],
    commonDefects: ['warpage', 'sink_mark', 'flash'],
    notes: 'PBT: fast crystallization. Mold temp dramatically affects surface & crystallinity (60-80°C amorphous / 80-100°C crystalline). Warpage from fast uneven crystallization.',
    source: 'experience', confidence: 'estimated' },
  ...
  'PC': { id: 'PC', tier: 'engineering', crystalline: false, hygroscopic: 'high',
    ...
    meltC: { min: 280, max: 320 }, moldC: { min: 80, max: 120 },
  ...
  'POM(아세탈)': { id: 'POM', tier: 'engineering', crystalline: true, hygroscopic: 'low',
    ...
    meltC: { min: 190, max: 210, degradeAbove: 220 }, moldC: { min: 80, max: 100 }, shrinkagePct: [1.8, 2.5],
  ...
  'PEEK': { id: 'PEEK', tier: 'super-engineering', crystalline: true, hygroscopic: 'low',
    ...
    source: 'experience', confidence: 'estimated' },
  'PEI(Ultem)': { id: 'PEI', tier: 'super-engineering', crystalline: false, hygroscopic: 'moderate',
    ...
    notes: 'PEI(Ultem): very high melt viscosity → needs high injection pressure → short shot risk. Moisture → splay. Beyond 9-type: stress cracking. Transparent amber.',
    source: 'experience', confidence: 'estimated' },
  ...
  'PP': { id: 'PP', tier: 'commodity', crystalline: true, hygroscopic: 'none',
    drying: null, meltC: { min: 200, max: 250 }, moldC: { min: 20, max: 60 }, shrinkagePct: [1.5, 2.5],
  ...
  'PE(HDPE)': { id: 'HDPE', tier: 'commodity', crystalline: true, hygroscopic: 'none',
    drying: null, meltC: { min: 200, max: 250 }, moldC: { min: 20, max: 60 }, shrinkagePct: [1.5, 3.0],
    commonDefects: ['warpage', 'sink_mark'],
  ...
  'PS': { id: 'PS', tier: 'commodity', crystalline: false, hygroscopic: 'none',
    drying: null, meltC: { min: 180, max: 240 }, moldC: { min: 20, max: 50 }, shrinkagePct: [0.3, 0.6],
  ...
  'ABS': { id: 'ABS', tier: 'commodity', crystalline: false, hygroscopic: 'low',
    drying: { tempC: 80, hours: [2, 4], targetMoisturePct: null },
    meltC: { min: 210, max: 250, degradeAbove: 260 }, moldC: { min: 40, max: 80 }, shrinkagePct: [0.4, 0.7],
  ...
  'PC/ABS': { id: 'PC/ABS', tier: 'blend', crystalline: false, hygroscopic: 'moderate',
    ...
    meltC: { min: 240, max: 280 }, moldC: { min: 60, max: 90 },
    commonDefects: ['silver_streak'],
    notes: 'PC/ABS: amorphous blend. Drying is critical, processing window narrower than either component alone. Moisture → splay. Beyond 9-type: delamination, color streaks.',
    source: 'experience', confidence: 'estimated' },
  ...
  'PPE/PA': { id: 'PPE/PA', tier: 'blend', crystalline: false, hygroscopic: 'moderate',
    ...
    notes: 'PPE/PA (Noryl GTX type): combines PPE heat resistance and PA chemical resistance.',
    source: 'experience', confidence: 'estimated' },
